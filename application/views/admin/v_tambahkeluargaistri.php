...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
	...
	<form action="<?php echo base_url(). '/home/updatedatakeluarga'; ?>" method="post">
		<table style="margin:20px auto;">
			...
			<tr>
				<td>Nama Istri</td>
				<td><input type="text" name="nama_istri" value=""></td>
			</tr>
			...
			<tr>
				<td>Tgl Lahir</td>
				<td><input type="text" name="tgl_lahir_istri" id="tgl_lahir_istri" value=""></td>
			</tr>
    ...
    $(document).ready(function(){
      var date_input=$('input[name="tgl_lahir_istri"]'); //our date input has the name "date"
