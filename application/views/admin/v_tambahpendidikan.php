...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
	...
	<form action="<?php echo base_url(). '/home/adddatapendidikan'; ?>" method="post">
		<table style="margin:20px auto;">
			...
			<tr>
				...
				<td><input type="text" name="tingkat" value=""></td>
			</tr>

			<tr>
				<td>Nama Perguruan</td>
				<td><input type="text" name="nama_perguruan" value=""></td>
			</tr>
			...
			<tr>
				<td>Tahun Lulus</td>
				<td><input type="text" name="thn_lulus" value=""></td>
			</tr>

			<tr>
				<td>No Ijazah</td>
				<td><input type="text" name="no_ijazah" value=""></td>
			</tr>
